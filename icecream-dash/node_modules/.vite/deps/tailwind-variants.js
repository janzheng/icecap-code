...
var se = (s, d) => {
  ...
  let $ = l(N) ? {} : { base: s == null ? void 0 : s.base, ...N }, h$1 = l(e == null ? void 0 : e.slots) ? $ : Y({ ...e == null ? void 0 : e.slots }, l($) ? { base: s == null ? void 0 : s.base } : $), v = (l2) => {
    ...
    let K = (t, n, a2 = [], i2) => {
      let r = a2;
      if (typeof n == "string")
        r = r.concat(k(n).split(" ").map((c) => `${t}:${c}`));
      ...
      let a2 = new Array();
      for (let i2 in g$1) {
        let r = W(i2, g$1, t, n), c = t === "base" && typeof r == "string" ? r : r && r[t];
        c && (a2[a2.length] = c);
      }
      return a2;
    }, z = {};
    ...
    if (!l(N) || !l(e == null ? void 0 : e.slots)) {
      ...
      if (typeof h$1 == "object" && !l(h$1))
        for (let n of Object.keys(h$1))
          t[n] = (a2) => {
            var i2, r;
            return w(h$1[n], P(n, a2), ((i2 = p2(a2)) != null ? i2 : [])[n], ((r = ee(a2)) != null ? r : [])[n], a2 == null ? void 0 : a2.class, a2 == null ? void 0 : a2.className)(m);
          };
      return t;
    }
